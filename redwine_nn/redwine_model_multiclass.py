...
# torch.save(model.state_dict(), "wine_model_multiclass.pth")
# print("Saved PyTorch Model State to model.pth")
model.load_state_dict(torch.load("wine_model_multiclass.pth"))
model.to(device)
...
# ans = [10.5, 0.24, 0.47, 2.1, 0.066, 6, 24, 0.9978, 3.15, 0.9, 11]  # 7
# ans = [7.3, 0.98, 0.05, 2.1, 0.061, 20, 49, 0.99705, 3.31, 0.55, 9.7]  # 3
# ans = [7.8, 0.88, 0.00, 2.6, 0.098, 25.0, 67.0, 0.9968, 3.20, 0.68, 9.8]  # 5
ans = [6.6, 0.815, 0.02, 2.7, 0.072, 17, 34, 0.9955, 3.58, 0.89, 12.3]  # 7
...
print("Quality: " + str(idx2class[res]))
